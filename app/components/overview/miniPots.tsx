  ...
  return (
    <div className={`bg-white m-2 p-1 hover:shadow-2xl rounded-lg ${animate}`}>
      ...
      <div className="h-40 flex flex-row">
        <div className="flex flex-row bg-black/5 w-1/2 h-full rounded-lg p-0">
          <DocumentCurrencyDollarIcon className=" text-green-400 w-30 h-30 mr-1" />

          <div className="flex flex-col w-full justify-center">
            <h4 className="text-xs font-medium text-black text-black/50 m-2">
              Total Saving
            </h4>
            <label className="text-xs md:text-md font-extrabold text-black">
              R12 000
            </label>
          </div>
        </div>
