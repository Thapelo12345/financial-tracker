...
import { HomeIcon, ArrowsUpDownIcon, ChartPieIcon, DocumentCurrencyDollarIcon, ReceiptRefundIcon } from "@heroicons/react/20/solid"
...
<header
 className={
`fixed z-10 bottom-0 left-0 bg-[rgb(13,13,13)] flex flex-row justify-evenly w-full rounded-none h-auto`
}
 >
